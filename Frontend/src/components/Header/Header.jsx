...
const Header = () => {
  return (
    ...
    <div className="bg-red-600 w-full h-full">
      <nav className="py-2 px-24 flex justify-evenly text-white items-center">
        {/* Logo or NamePage */}
        <a href="">EcommerceProjectX</a>
        {/* Categories */}
        <a
          href=""
          className="flex bg-red-500 rounded-lg p-3 text-xs items-center"
        >
          <div>
            <svg
        ...
        <a
          href=""
          className="flex bg-red-500 rounded-lg p-1 text-xs items-center"
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div>
            ...
            <p className="text-sm">HoChiMinh</p>
          </div>
        </a>
        {/* Searching */}
        <div>
        ...
        {/* Store */}
        <a href="" className="flex text-xs items-center">
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
